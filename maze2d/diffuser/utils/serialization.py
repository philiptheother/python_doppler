...
RLExperiment = namedtuple('RL', 'dataset renderer trainer epoch')
...
def load_q(*loadpath, epoch='latest', device='cuda:0'):
    ...
    trainer = trainer_config(dataset, renderer)
    ...
    return RLExperiment(dataset, renderer, trainer, epoch)
